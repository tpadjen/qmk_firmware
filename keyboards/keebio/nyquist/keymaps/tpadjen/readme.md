# tpadjen's nyquist/levinson layout
...
## Goals
  ...
  * Nyquist uses only the lower 4 rows (like a Levinson) to allow the trrs connector to hang outside the case and decrease the height of the keyboard significantly
